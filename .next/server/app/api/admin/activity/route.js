"use strict";(()=>{var e={};e.id=152,e.ids=[152],e.modules={72934:e=>{e.exports=require("next/dist/client/components/action-async-storage.external.js")},54580:e=>{e.exports=require("next/dist/client/components/request-async-storage.external.js")},45869:e=>{e.exports=require("next/dist/client/components/static-generation-async-storage.external.js")},20399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},30517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},78893:e=>{e.exports=require("buffer")},84770:e=>{e.exports=require("crypto")},92048:e=>{e.exports=require("fs")},85861:e=>{e.exports=require("node:sqlite")},55315:e=>{e.exports=require("path")},76162:e=>{e.exports=require("stream")},21764:e=>{e.exports=require("util")},6005:e=>{e.exports=require("node:crypto")},26039:(e,t,n)=>{n.r(t),n.d(t,{originalPathname:()=>h,patchFetch:()=>N,requestAsyncStorage:()=>c,routeModule:()=>T,serverHooks:()=>p,staticGenerationAsyncStorage:()=>E});var r={};n.r(r),n.d(r,{GET:()=>d});var s=n(49303),i=n(88716),a=n(60670),u=n(87070),o=n(9487),l=n(90455);async function d(){let e=(0,l.ts)();if(!e)return u.NextResponse.json({error:"Not signed in."},{status:401});if("admin"!==e.role)return u.NextResponse.json({error:"Admin access only."},{status:403});let t=[];try{t=o.db.prepare(`SELECT u.id, u.issue_id, u.actor_id, u.message, u.created_at, i.ticket_no, actor.name AS actor_name
       FROM updates u
       LEFT JOIN issues i ON i.id = u.issue_id
       LEFT JOIN users actor ON actor.id = u.actor_id
       ORDER BY u.created_at DESC
       LIMIT 5`).all()}catch(e){console.warn("Failed to read activity during build or runtime:",e),t=[]}return u.NextResponse.json({activity:t})}let T=new s.AppRouteRouteModule({definition:{kind:i.x.APP_ROUTE,page:"/api/admin/activity/route",pathname:"/api/admin/activity",filename:"route",bundlePath:"app/api/admin/activity/route"},resolvedPagePath:"/Users/tony/Downloads/fixhubgh/app/api/admin/activity/route.ts",nextConfigOutput:"",userland:r}),{requestAsyncStorage:c,staticGenerationAsyncStorage:E,serverHooks:p}=T,h="/api/admin/activity/route";function N(){return(0,a.patchFetch)({serverHooks:p,staticGenerationAsyncStorage:E})}},90455:(e,t,n)=>{n.d(t,{CX:()=>E,GA:()=>p,Rf:()=>d,Uj:()=>l,ax:()=>c,ts:()=>T});var r=n(41482),s=n.n(r),i=n(71615),a=n(9487);let u=process.env.SESSION_SECRET||"hostel-maintenance-dev-secret-change-me",o="hostel_session";function l(e){let t=s().sign(e,u,{expiresIn:"7d"});(0,i.cookies)().set(o,t,{httpOnly:!0,sameSite:"lax",path:"/",maxAge:604800})}function d(){(0,i.cookies)().set(o,"",{path:"/",maxAge:0})}function T(){let e=i.cookies().get(o)?.value;if(!e)return null;try{let t=s().verify(e,u),n=p(t.id);if(!n||1!==n.is_active)return null;return c(n)}catch{return null}}function c(e){return{id:e.id,name:e.name,email:e.email,role:e.role,room:e.room,hostel:e.hostel,specialty:e.specialty,avatar_url:e.avatar_url,phone:e.phone,bio:e.bio,is_active:e.is_active}}function E(e){return a.db.prepare("SELECT * FROM users WHERE email = ?").get(e)}function p(e){return a.db.prepare("SELECT * FROM users WHERE id = ?").get(e)}},47090:(e,t,n)=>{n.d(t,{aA:()=>r,bV:()=>i,tb:()=>s});let r=["Electrical","Plumbing","Internet","Furniture","Pest Control","Cleaning","Other"],s=["Main","North","South","East","West","Annex"],i=["reported","assigned","in_progress","review","resolved"]},9487:(e,t,n)=>{n.d(t,{db:()=>p});var r=n(85861),s=n(55315),i=n.n(s),a=n(92048),u=n.n(a),o=n(42023),l=n.n(o),d=n(42549),T=n(47090);let c=i().join(process.cwd(),"data");u().existsSync(c)||u().mkdirSync(c,{recursive:!0});let E=i().join(c,"hostel.db"),p=global.__hostelDb??function(){let e=new r.DatabaseSync(E);return e.exec("PRAGMA journal_mode = WAL;"),e}();!function(){p.exec(`
