"use strict";(()=>{var e={};e.id=716,e.ids=[716],e.modules={72934:e=>{e.exports=require("next/dist/client/components/action-async-storage.external.js")},54580:e=>{e.exports=require("next/dist/client/components/request-async-storage.external.js")},45869:e=>{e.exports=require("next/dist/client/components/static-generation-async-storage.external.js")},20399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},30517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},78893:e=>{e.exports=require("buffer")},84770:e=>{e.exports=require("crypto")},92048:e=>{e.exports=require("fs")},85861:e=>{e.exports=require("node:sqlite")},55315:e=>{e.exports=require("path")},76162:e=>{e.exports=require("stream")},21764:e=>{e.exports=require("util")},6005:e=>{e.exports=require("node:crypto")},46917:(e,t,n)=>{n.r(t),n.d(t,{originalPathname:()=>p,patchFetch:()=>h,requestAsyncStorage:()=>T,routeModule:()=>d,serverHooks:()=>c,staticGenerationAsyncStorage:()=>E});var s={};n.r(s),n.d(s,{POST:()=>l});var r=n(49303),i=n(88716),u=n(60670),a=n(87070),o=n(90455);async function l(){return(0,o.Rf)(),a.NextResponse.json({ok:!0})}let d=new r.AppRouteRouteModule({definition:{kind:i.x.APP_ROUTE,page:"/api/auth/logout/route",pathname:"/api/auth/logout",filename:"route",bundlePath:"app/api/auth/logout/route"},resolvedPagePath:"/Users/tony/Downloads/fixhubgh/app/api/auth/logout/route.ts",nextConfigOutput:"",userland:s}),{requestAsyncStorage:T,staticGenerationAsyncStorage:E,serverHooks:c}=d,p="/api/auth/logout/route";function h(){return(0,u.patchFetch)({serverHooks:c,staticGenerationAsyncStorage:E})}},90455:(e,t,n)=>{n.d(t,{CX:()=>c,GA:()=>p,Rf:()=>d,Uj:()=>l,ax:()=>E,ts:()=>T});var s=n(41482),r=n.n(s),i=n(71615),u=n(9487);let a=process.env.SESSION_SECRET||"hostel-maintenance-dev-secret-change-me",o="hostel_session";function l(e){let t=r().sign(e,a,{expiresIn:"7d"});(0,i.cookies)().set(o,t,{httpOnly:!0,sameSite:"lax",path:"/",maxAge:604800})}function d(){(0,i.cookies)().set(o,"",{path:"/",maxAge:0})}function T(){let e=i.cookies().get(o)?.value;if(!e)return null;try{let t=r().verify(e,a),n=p(t.id);if(!n||1!==n.is_active)return null;return E(n)}catch{return null}}function E(e){return{id:e.id,name:e.name,email:e.email,role:e.role,room:e.room,hostel:e.hostel,specialty:e.specialty,avatar_url:e.avatar_url,phone:e.phone,bio:e.bio,is_active:e.is_active}}function c(e){return u.db.prepare("SELECT * FROM users WHERE email = ?").get(e)}function p(e){return u.db.prepare("SELECT * FROM users WHERE id = ?").get(e)}},47090:(e,t,n)=>{n.d(t,{aA:()=>s,bV:()=>i,tb:()=>r});let s=["Electrical","Plumbing","Internet","Furniture","Pest Control","Cleaning","Other"],r=["Main","North","South","East","West","Annex"],i=["reported","assigned","in_progress","review","resolved"]},9487:(e,t,n)=>{n.d(t,{db:()=>p});var s=n(85861),r=n(55315),i=n.n(r),u=n(92048),a=n.n(u),o=n(42023),l=n.n(o),d=n(42549),T=n(47090);let E=i().join(process.cwd(),"data");a().existsSync(E)||a().mkdirSync(E,{recursive:!0});let c=i().join(E,"hostel.db"),p=global.__hostelDb??function(){let e=new s.DatabaseSync(c);return e.exec("PRAGMA journal_mode = WAL;"),e}();!function(){p.exec(`
