"use strict";(()=>{var e={};e.id=873,e.ids=[873],e.modules={72934:e=>{e.exports=require("next/dist/client/components/action-async-storage.external.js")},54580:e=>{e.exports=require("next/dist/client/components/request-async-storage.external.js")},45869:e=>{e.exports=require("next/dist/client/components/static-generation-async-storage.external.js")},20399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},30517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},78893:e=>{e.exports=require("buffer")},84770:e=>{e.exports=require("crypto")},92048:e=>{e.exports=require("fs")},85861:e=>{e.exports=require("node:sqlite")},55315:e=>{e.exports=require("path")},76162:e=>{e.exports=require("stream")},21764:e=>{e.exports=require("util")},6005:e=>{e.exports=require("node:crypto")},69351:(e,t,n)=>{n.r(t),n.d(t,{originalPathname:()=>N,patchFetch:()=>m,requestAsyncStorage:()=>E,routeModule:()=>c,serverHooks:()=>h,staticGenerationAsyncStorage:()=>p});var s={};n.r(s),n.d(s,{POST:()=>T});var r=n(49303),i=n(88716),a=n(60670),u=n(87070),o=n(42023),l=n.n(o),d=n(90455);async function T(e){let t=await e.json().catch(()=>null),n=t?.email?.toLowerCase()?.trim(),s=t?.password;if(!n||!s)return u.NextResponse.json({error:"Email and password are required."},{status:400});let r=(0,d.CX)(n);if(!r||!l().compareSync(s,r.password_hash))return u.NextResponse.json({error:"Incorrect email or password."},{status:401});if(1!==r.is_active)return u.NextResponse.json({error:"This account is deactivated. Contact an administrator."},{status:403});let i=(0,d.ax)(r);return(0,d.Uj)(i),u.NextResponse.json({user:i})}let c=new r.AppRouteRouteModule({definition:{kind:i.x.APP_ROUTE,page:"/api/auth/login/route",pathname:"/api/auth/login",filename:"route",bundlePath:"app/api/auth/login/route"},resolvedPagePath:"/Users/tony/Downloads/fixhubgh/app/api/auth/login/route.ts",nextConfigOutput:"",userland:s}),{requestAsyncStorage:E,staticGenerationAsyncStorage:p,serverHooks:h}=c,N="/api/auth/login/route";function m(){return(0,a.patchFetch)({serverHooks:h,staticGenerationAsyncStorage:p})}},90455:(e,t,n)=>{n.d(t,{CX:()=>E,GA:()=>p,Rf:()=>d,Uj:()=>l,ax:()=>c,ts:()=>T});var s=n(41482),r=n.n(s),i=n(71615),a=n(9487);let u=process.env.SESSION_SECRET||"hostel-maintenance-dev-secret-change-me",o="hostel_session";function l(e){let t=r().sign(e,u,{expiresIn:"7d"});(0,i.cookies)().set(o,t,{httpOnly:!0,sameSite:"lax",path:"/",maxAge:604800})}function d(){(0,i.cookies)().set(o,"",{path:"/",maxAge:0})}function T(){let e=i.cookies().get(o)?.value;if(!e)return null;try{let t=r().verify(e,u),n=p(t.id);if(!n||1!==n.is_active)return null;return c(n)}catch{return null}}function c(e){return{id:e.id,name:e.name,email:e.email,role:e.role,room:e.room,hostel:e.hostel,specialty:e.specialty,avatar_url:e.avatar_url,phone:e.phone,bio:e.bio,is_active:e.is_active}}function E(e){return a.db.prepare("SELECT * FROM users WHERE email = ?").get(e)}function p(e){return a.db.prepare("SELECT * FROM users WHERE id = ?").get(e)}},47090:(e,t,n)=>{n.d(t,{aA:()=>s,bV:()=>i,tb:()=>r});let s=["Electrical","Plumbing","Internet","Furniture","Pest Control","Cleaning","Other"],r=["Main","North","South","East","West","Annex"],i=["reported","assigned","in_progress","review","resolved"]},9487:(e,t,n)=>{n.d(t,{db:()=>p});var s=n(85861),r=n(55315),i=n.n(r),a=n(92048),u=n.n(a),o=n(42023),l=n.n(o),d=n(42549),T=n(47090);let c=i().join(process.cwd(),"data");u().existsSync(c)||u().mkdirSync(c,{recursive:!0});let E=i().join(c,"hostel.db"),p=global.__hostelDb??function(){let e=new s.DatabaseSync(E);return e.exec("PRAGMA journal_mode = WAL;"),e}();!function(){p.exec(`
